...
public class RelicStatueBlock extends Block
{
    ...
    public RelicStatueBlock() {
        ...
        this.registerDefaultState((BlockState)((BlockState)this.stateDefinition.any()).setValue((Property)RelicStatueBlock.FACING, (Comparable)Direction.SOUTH));
    }
    
    @Nullable
    public BlockState getStateForPlacement(final BlockItemUseContext context) {
        return (BlockState)this.defaultBlockState().setValue((Property)RelicStatueBlock.FACING, (Comparable)context.getHorizontalDirection());
    }
