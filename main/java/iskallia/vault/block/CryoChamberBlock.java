...
public class CryoChamberBlock extends Block {
    ...
    public CryoChamberBlock() {
        super(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL)
                .strength(5.0f, 3600000.0f).sound(SoundType.METAL).noOcclusion()
                .isRedstoneConductor(CryoChamberBlock::isntSolid).isViewBlocking(CryoChamberBlock::isntSolid));
        this.registerDefaultState((BlockState) ((BlockState) ((BlockState) ((BlockState) this.stateDefinition.any())
                .setValue((Property) CryoChamberBlock.FACING, (Comparable) Direction.NORTH))
                .setValue((Property) CryoChamberBlock.HALF, (Comparable) DoubleBlockHalf.LOWER))
                .setValue((Property) CryoChamberBlock.CHAMBER_STATE, (Comparable) ChamberState.NONE));
    }
    ...
    public BlockState getStateForPlacement(final BlockItemUseContext context) {
        ...
        if (pos.getY() < 255 && world.getBlockState(pos.above()).canBeReplaced(context)) {
            return (BlockState) ((BlockState) ((BlockState) this.defaultBlockState()
                    .setValue((Property) CryoChamberBlock.FACING, (Comparable) context.getHorizontalDirection()))
                    .setValue((Property) CryoChamberBlock.HALF, (Comparable) DoubleBlockHalf.LOWER))
                    .setValue((Property) CryoChamberBlock.CHAMBER_STATE,
                            (Comparable) MiscUtils.getEnumEntry(
                                    (Class<Comparable<Comparable<Comparable<Comparable<T>>>>>) ChamberState.class,
    ...
    protected void createBlockStateDefinition(final StateContainer.Builder<Block, BlockState> builder) {
        builder.add(new Property[] { (Property) CryoChamberBlock.HALF, (Property) CryoChamberBlock.FACING,
                (Property) CryoChamberBlock.CHAMBER_STATE });
    }
        ...
        if (!worldIn.isClientSide && player.isCreative()) {
            ...
            if (half == DoubleBlockHalf.UPPER) {
                ...
                if (blockstate.getBlock() == state.getBlock()
                        && blockstate.getValue((Property) CryoChamberBlock.HALF) == DoubleBlockHalf.LOWER) {
    ...
    public BlockState updateShape(final BlockState stateIn, final Direction facing, final BlockState facingState,
        ...
        if (facing.getAxis() == Direction.Axis.Y && half == DoubleBlockHalf.LOWER == (facing == Direction.UP)) {
            return (BlockState) ((facingState.is((Block) this)
                    && facingState.getValue((Property) CryoChamberBlock.HALF) != half)
                            ? stateIn.setValue((Property) CryoChamberBlock.FACING,
                                    facingState.getValue((Property) CryoChamberBlock.FACING))
    ...
    public void setPlacedBy(final World worldIn, final BlockPos pos, final BlockState state,
        ...
        worldIn.setBlock(pos.above(),
                (BlockState) state.setValue((Property) CryoChamberBlock.HALF, (Comparable) DoubleBlockHalf.UPPER),
                3);
        if (placer != null) {
    ...
    private void dropCryoChamber(final World world, final BlockPos pos, final BlockState state,
            final CryoChamberTileEntity te) {
        final ItemStack chamberStack = new ItemStack((IItemProvider) ModBlocks.CRYO_CHAMBER);
        chamberStack.setDamageValue(
                ((ChamberState) state.getValue((Property) CryoChamberBlock.CHAMBER_STATE)).ordinal());
    ...
    public ActionResultType use(final BlockState state, final World world, final BlockPos pos,
        ...
        if (chamber.getEternal() != null) {
            if (!player.isShiftKeyDown()) {
                NetworkHooks.openGui((ServerPlayerEntity) player, (INamedContainerProvider) chamber,
            ...
            if (heldStack.isEmpty()) {
                ...
                NetworkHooks.openGui((ServerPlayerEntity) player,
                        (INamedContainerProvider) new INamedContainerProvider() {
        ...
        } else if (!((ChamberState) state.getValue((Property) CryoChamberBlock.CHAMBER_STATE)).containsAncient()
    ...
    public static BlockPos getCryoChamberPos(final BlockState state, final BlockPos pos) {
        return (state.getValue((Property) CryoChamberBlock.HALF) == DoubleBlockHalf.UPPER) ? pos.below()
                : pos;
    }

    public static CryoChamberTileEntity getCryoChamberTileEntity(final World world, final BlockPos pos,
