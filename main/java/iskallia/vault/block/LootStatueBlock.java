...
public class LootStatueBlock extends Block {
    ...
    protected LootStatueBlock(final StatueType type, final AbstractBlock.Properties properties) {
        super(properties);
        this.registerDefaultState((BlockState) ((BlockState) this.getStateDefinition().any())
                .setValue((Property) LootStatueBlock.FACING, (Comparable) Direction.SOUTH));
        this.type = type;
    }
    ...
    public BlockState getStateForPlacement(final BlockItemUseContext context) {
        ...
        if (pos.getY() < 255 && world.getBlockState(pos.above()).canBeReplaced(context)) {
            return (BlockState) this.defaultBlockState().setValue((Property) LootStatueBlock.FACING,
