...
public class ScavengerChestTileEntity extends ChestTileEntity
{
    ...
    protected Container createMenu(final int id, final PlayerInventory playerInventory) {
        Container ct = (Container)new ScavengerChestContainer(id, playerInventory, (IInventory)this, (IInventory)this);
        if (this.level instanceof ServerWorld) {
            ...
            if (vault != null) {
                ct = vault.getActiveObjective(ScavengerHuntObjective.class).map(objective -> {
                    final Container linkedCt = (Container)new ScavengerChestContainer(id, playerInventory, (IInventory)this, objective.getScavengerChestInventory());
