...
public class SoulAltarTileEntity extends FillableAltarTileEntity
{
    ...
    public void tick() {
        ...
        if (!this.getLevel().isClientSide()) {
            ...
            this.getLevel().getLoadedEntitiesOfClass((Class)LivingEntity.class, SoulAltarTileEntity.SEARCH_BOX.move(this.getBlockPos()), entity -> entity.isAlive() && !entity.isSpectator() && !entity.isInvulnerable() && entity.getType().getCategory() == EntityClassification.MONSTER).forEach(entity -> {
