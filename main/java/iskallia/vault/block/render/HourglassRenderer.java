...
public class HourglassRenderer extends TileEntityRenderer<HourglassTileEntity>
{
    ...
    private static void shiftY(final float y) {
        HourglassRenderer.SAND_BOXES = HourglassRenderer.SAND_BOXES.stream().map(box -> box.move(0.0, (double)y, 0.0)).collect((Collector<? super Object, ?, List<AxisAlignedBB>>)Collectors.toList());
    }
