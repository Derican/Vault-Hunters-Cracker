...
public class VendingMachineRenderer extends TileEntityRenderer<VendingMachineTileEntity> {
    ...
    public void render(final VendingMachineTileEntity tileEntity, final float partialTicks,
        ...
        if (minecraft.player != null
                && minecraft.player.getMainHandItem().getItem() == ModItems.TRADER_CORE) {
        ...
        this.renderTrader(matrixStack, blockState, renderCore,
                buffer.getBuffer(VendingMachineRenderer.PLAYER_MODEL.renderType(skinLocation)), combinedLight,
                combinedOverlay, 1.0f);
    ...
    public void renderTrader(final MatrixStack matrixStack, final BlockState blockState, final TraderCore renderCore,
            final IVertexBuilder vertexBuilder, final int combinedLight, final int combinedOverlay, final float alpha) {
        ...
        VendingMachineRenderer.PLAYER_MODEL.body.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        VendingMachineRenderer.PLAYER_MODEL.leftLeg.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        VendingMachineRenderer.PLAYER_MODEL.rightLeg.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        VendingMachineRenderer.PLAYER_MODEL.leftArm.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        VendingMachineRenderer.PLAYER_MODEL.rightArm.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        VendingMachineRenderer.PLAYER_MODEL.jacket.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        VendingMachineRenderer.PLAYER_MODEL.leftPants.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        VendingMachineRenderer.PLAYER_MODEL.rightPants.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        VendingMachineRenderer.PLAYER_MODEL.leftSleeve.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        matrixStack.pushPose();
        matrixStack.translate(0.0, 0.0, -0.6200000047683716);
        VendingMachineRenderer.PLAYER_MODEL.rightSleeve.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        matrixStack.popPose();
        VendingMachineRenderer.PLAYER_MODEL.hat.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        VendingMachineRenderer.PLAYER_MODEL.head.render(matrixStack, vertexBuilder, combinedLight,
                combinedOverlay, 1.0f, 1.0f, 1.0f, alpha);
        matrixStack.popPose();
    }
