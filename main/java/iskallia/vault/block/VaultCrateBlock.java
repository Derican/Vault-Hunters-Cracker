...
public class VaultCrateBlock extends Block
{
    ...
    public VaultCrateBlock() {
        ...
        this.registerDefaultState((BlockState)((BlockState)this.defaultBlockState().setValue((Property)VaultCrateBlock.HORIZONTAL_FACING, (Comparable)Direction.NORTH)).setValue((Property)VaultCrateBlock.FACING, (Comparable)Direction.UP));
    }
    ...
    public static ItemStack getCrateWithLoot(final VaultCrateBlock crateType, NonNullList<ItemStack> items) {
        if (items.size() > 54) {
            ...
            items = (NonNullList<ItemStack>)NonNullList.of((Object)ItemStack.EMPTY, items.stream().limit(54L).toArray(ItemStack[]::new));
        }
    ...
    protected void createBlockStateDefinition(final StateContainer.Builder<Block, BlockState> builder) {
        builder.add(new Property[] { (Property)VaultCrateBlock.HORIZONTAL_FACING, (Property)VaultCrateBlock.FACING });
    }
    ...
    public BlockState getStateForPlacement(final BlockItemUseContext context) {
        ...
        return (BlockState)((BlockState)this.defaultBlockState().setValue((Property)VaultCrateBlock.FACING, (Comparable)placeDir)).setValue((Property)VaultCrateBlock.HORIZONTAL_FACING, (Comparable)horizontalDir);
    }
