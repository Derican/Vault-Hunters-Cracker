...
public class OmegaStatueModel extends EntityModel<Entity> {
    ...
    public void setupAnim(final Entity entity, final float limbSwing, final float limbSwingAmount,
    ...
    private void initCrystals() {
        ...
        this.largecrystal21.texOffs(38, 5).addBox(-0.875f, -2.0417f, -0.75f, 1.0f, 3.0f, 1.0f, 0.0f,
                false);
        ...
        this.largecrystal25.texOffs(14, 2).addBox(-0.875f, -2.0417f, -0.75f, 1.0f, 3.0f, 1.0f, 0.0f,
                false);
