...
public abstract class FacedBlock extends Block {
    ...
    public BlockState getStateForPlacement(final BlockItemUseContext context) {
        return (BlockState) this.defaultBlockState().setValue((Property) FacedBlock.FACING,
                (Comparable) context.getHorizontalDirection());
    }

    public BlockState rotate(final BlockState state, final Rotation rot) {
        return (BlockState) state.setValue((Property) FacedBlock.FACING,
                (Comparable) rot.rotate((Direction) state.getValue((Property) FacedBlock.FACING)));
    }

    public BlockState mirror(final BlockState state, final Mirror mirrorIn) {
        return state
                .rotate(mirrorIn.getRotation((Direction) state.getValue((Property) FacedBlock.FACING)));
    }
