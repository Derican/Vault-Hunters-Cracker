...
public class FinalVaultPortalBlock extends NetherPortalBlock {
    public FinalVaultPortalBlock() {
        ...
        this.registerDefaultState((BlockState) ((BlockState) this.stateDefinition.any())
                .setValue((Property) FinalVaultPortalBlock.AXIS, (Comparable) Direction.Axis.X));
    }

    public void fillItemCategory(final ItemGroup group, final NonNullList<ItemStack> items) {
    }

    protected static BlockPos getSpawnPoint(final ServerWorld p_241092_0_, final int p_241092_1_, final int p_241092_2_,
            final boolean p_241092_3_) {
        ...
        final int i = flag ? p_241092_0_.getChunkSource().getGenerator().getSpawnHeight()
                : chunk.getHeight(Heightmap.Type.MOTION_BLOCKING, p_241092_1_ & 0xF, p_241092_2_ & 0xF);
        if (i < 0) {
            return null;
        }
    ...
    public BlockState updateShape(final BlockState stateIn, final Direction facing, final BlockState facingState,
        ...
        if (world != null && world.dimension() == World.OVERWORLD) {
            ...
            final Direction.Axis direction$axis2 = (Direction.Axis) stateIn
                    .getValue((Property) FinalVaultPortalBlock.AXIS);
    ...
    public void entityInside(final BlockState state, final World world, final BlockPos pos, final Entity entity) {
        ...
        final VoxelShape playerVoxel = VoxelShapes.create(player.getBoundingBox().move(
