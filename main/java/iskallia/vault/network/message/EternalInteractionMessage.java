...
public class EternalInteractionMessage {
    ...
    public static EternalInteractionMessage decode(final PacketBuffer buffer) {
        final EternalInteractionMessage pkt = new EternalInteractionMessage(
                (Action) buffer.readEnum((Class) Action.class));
        pkt.extraData = buffer.readNbt();
        return pkt;
    }

    public static void handle(final EternalInteractionMessage pkt,
        ...
        // 12: aload_0 /* pkt */
        // 13: invokedynamic BootstrapMethod #0,
        // run:(Ljava/util/function/Supplier;Liskallia/vault/network/message/EternalInteractionMessage;)Ljava/lang/Runnable;
        // 18: invokevirtual
        // net/minecraftforge/fml/network/NetworkEvent$Context.enqueueWork:(Ljava/lang/Runnable;)Ljava/util/concurrent/CompletableFuture;
        // 21: pop
        // 22: aload_2 /* context */
        // 23: iconst_1
        // 24: invokevirtual
        // net/minecraftforge/fml/network/NetworkEvent$Context.setPacketHandled:(Z)V
        // 27: return
        // Signature:
        ...
        // "com.strobel.assembler.metadata.TypeReference.getSimpleType()" because the
        // return value of "com.strobel.decompiler.ast.Variable.getType()" is null
        // at
        // com.strobel.decompiler.languages.java.ast.NameVariables.generateNameForVariable(NameVariables.java:252)
        // at
        // com.strobel.decompiler.languages.java.ast.NameVariables.assignNamesToVariables(NameVariables.java:185)
        // at
        // com.strobel.decompiler.languages.java.ast.AstMethodBodyBuilder.nameVariables(AstMethodBodyBuilder.java:1482)
        // at
        // com.strobel.decompiler.languages.java.ast.AstMethodBodyBuilder.populateVariables(AstMethodBodyBuilder.java:1411)
        // at
    ...
    public static boolean canBeFed(final EternalDataAccess eternal, final ItemStack stack) {
        return !stack.isEmpty() && ((!eternal.isAlive() && stack.getItem().equals(ModItems.LIFE_SCROLL))
                || stack.getItem().equals(ModItems.AURA_SCROLL) || (eternal.getLevel() < eternal.getMaxLevel()
                        && ModConfigs.ETERNAL.getFoodExp(stack.getItem()).isPresent()));
    }
