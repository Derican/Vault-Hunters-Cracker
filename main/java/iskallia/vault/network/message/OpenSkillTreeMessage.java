...
public class OpenSkillTreeMessage {
    ...
    public static void handle(final OpenSkillTreeMessage message,
        ...
        context.enqueueWork(() -> {
            ...
            if (sender == null) {
                ...
                final PlayerAbilitiesData playerAbilitiesData = PlayerAbilitiesData
                ...
                final PlayerResearchesData playerResearchesData = PlayerResearchesData
                        .get((ServerWorld) sender.level);
                ...
                NetworkHooks.openGui(sender, (INamedContainerProvider) new INamedContainerProvider() {
                    ...
                    public Container createMenu(final int i, final PlayerInventory playerInventory,
                        ...
                        return new SkillTreeContainer(i, this.val$abilityTree, this.val$talentTree,
                                this.val$researchTree);
                    }
                }, buffer -> {
