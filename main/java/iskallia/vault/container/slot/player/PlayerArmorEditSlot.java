...
public class PlayerArmorEditSlot extends Slot {
    ...
    public PlayerArmorEditSlot(final PlayerInventory inventory, final EquipmentSlotType slotType, final int index,
    ...
    public Pair<ResourceLocation, ResourceLocation> getNoItemIcon() {
        ...
        return (Pair<ResourceLocation, ResourceLocation>) Pair.of((Object) PlayerContainer.BLOCK_ATLAS,
                (Object) PlayerArmorEditSlot.ARMOR_SLOT_TEXTURES[this.slotType.getIndex()]);
    }
