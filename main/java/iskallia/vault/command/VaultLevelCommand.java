...
public class VaultLevelCommand extends Command {
    ...
    public void build(final LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(Commands.literal("add_exp").then(
                Commands.argument("exp", (ArgumentType) IntegerArgumentType.integer()).executes(this::addExp)));
        builder.then(Commands.literal("set_level").then(Commands
                .argument("level", (ArgumentType) IntegerArgumentType.integer()).executes(this::setLevel)));
