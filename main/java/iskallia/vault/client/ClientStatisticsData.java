...
public class ClientStatisticsData {
    ...
    public static void receiveUpdate(final CompoundNBT statisticsData) {
        ...
        for (int i = 0; i < attributes.size(); ++i) {
            ClientStatisticsData.attributeValues
                    .add(PlayerStatisticsCollector.AttributeSnapshot.deserialize(attributes.getCompound(i)));
        }
    ...
    public static List<PlayerStatisticsCollector.AttributeSnapshot> getPlayerAttributeSnapshots() {
        return Collections.unmodifiableList(
                (List<? extends PlayerStatisticsCollector.AttributeSnapshot>) ClientStatisticsData.attributeValues);
    }
