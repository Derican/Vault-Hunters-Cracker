...
public class EyesoreAppearanceParticle extends Particle {
    ...
    public void render(@Nonnull final IVertexBuilder buffer, final ActiveRenderInfo renderInfo,
        ...
        this.model.renderToBuffer(matrixstack, ivertexbuilder, 15728880, OverlayTexture.NO_OVERLAY, 1.0f, 1.0f,
                1.0f, f2);
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(@Nonnull final BasicParticleType typeIn, @Nonnull final ClientWorld worldIn,
