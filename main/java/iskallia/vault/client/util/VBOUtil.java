...
public class VBOUtil {
    public static VertexBuffer batch(final EntityModel<?> model, final RenderType renderType, final int packedLight,
        ...
        model.renderToBuffer(new MatrixStack(), (IVertexBuilder) buf, packedLight, packedOverlay, 1.0f, 1.0f, 1.0f,
                1.0f);
        buf.end();
        vbo.upload(buf);
        return vbo;
