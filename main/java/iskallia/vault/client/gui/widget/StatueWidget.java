...
public class StatueWidget extends Widget {
    ...
    public StatueWidget(final int x, final int y, final String name, final int count,
            final StatueCauldronScreen parentScreen) {
    ...
    public void render(final MatrixStack matrixStack, final int mouseX, final int mouseY,
        ...
        blit(matrixStack, this.x, this.y, 225.0f,
        ...
        minecraft.font.draw(matrixStack, (ITextComponent) nameText, startXname,
                (float) (this.y + 4), -1);
        ...
        minecraft.font.draw(matrixStack, (ITextComponent) countText, startXcount,
                (float) (this.y + 14), -1);
