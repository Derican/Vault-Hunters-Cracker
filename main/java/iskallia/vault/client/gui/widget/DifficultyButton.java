...
public class DifficultyButton extends Button {
    ...
    public DifficultyButton(final String text, final String key, final int x, final int y, final int width,
            final int height, final ITextComponent label, final Button.IPressable onPress) {
    ...
    public void renderToolTip(final MatrixStack matrixStack, final int mouseX, final int mouseY) {
        ...
        GuiUtils.drawHoveringText(matrixStack, (List) tooltips, mouseX, mouseY, this.width + mouseX,
                this.height + mouseY, -1, Minecraft.getInstance().font);
    }
}
