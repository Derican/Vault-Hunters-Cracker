...
public class AbilitiesTab extends SkillTab {
    ...
    public void refresh() {
        ...
        ModConfigs.ABILITIES_GUI.getStyles().forEach((abilityName, style) -> this.abilityWidgets.put(abilityName,
                new AbilityWidget(abilityName, abilityTree, style)));
        ModConfigs.ABILITIES_GUI.getStyles().forEach((abilityName, style) -> {
            ...
            if (!abilityName.equals(ability.getAbilityGroupName())) {
                ...
                if (abilityGroup != null && thisAbility != null) {
                    final ConnectorWidget widget = new ConnectorWidget(abilityGroup, thisAbility,
                            ConnectorWidget.ConnectorType.LINE);
