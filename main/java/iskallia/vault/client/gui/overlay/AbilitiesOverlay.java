...
public class AbilitiesOverlay {
    ...
    public static void onPostRender(final RenderGameOverlayEvent.Post event) {
        ...
        final String styleKey = (selectAbilityNode.getSpecialization() != null) ? selectAbilityNode.getSpecialization()
        ...
        final String prevStyleKey = (previousAbility.getSpecialization() != null) ? previousAbility.getSpecialization()
        ...
        final String nextStyleKey = (nextAbility.getSpecialization() != null) ? nextAbility.getSpecialization()
                : nextAbility.getGroup().getParentName();
        ...
        minecraft.gui.blit(matrixStack, 19, -1,
                64 + ((selectedCooldown > 0) ? 50 : (ClientAbilityData.isActive() ? 25 : 0)), 13, 24, 24);
        matrixStack.popPose();
