    ...
    private void refreshButtons() {
        ...
        if (snapshot.getAbilityName() == null) {
            ...
            for (final EternalAuraConfig.AuraConfig abilityOption : options) {
                this.addButton((Widget)new TooltipImageButton(abilityX, abilityY, 24, 24, 192, 0, 24, CryochamberScreen.TEXTURE, 256, 256, btn -> ModNetwork.CHANNEL.sendToServer((Object)EternalInteractionMessage.selectEffect(abilityOption.getName()))));
                abilityX += 30;
            }
        }
    }
