...
public class VaultISTER extends ItemStackTileEntityRenderer {
    ...
    public void renderByItem(final ItemStack stack, final ItemCameraTransforms.TransformType type,
        ...
        if (world != null && stack.getItem() instanceof BlockItem) {
            ...
            if (block instanceof VaultChestBlock) {
                ...
                if (te instanceof VaultChestTileEntity) {
                    ...
                    TileEntityRendererDispatcher.instance.renderItem(te, matrixStack, buffer, combinedLight,
                            combinedOverlay);
                }
            }
