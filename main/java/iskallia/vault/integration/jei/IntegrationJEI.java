...
public class IntegrationJEI implements IModPlugin {
    ...
    public void registerRecipes(final IRecipeRegistration registration) {
        ...
        registration.addRecipes((Collection) DummyRecipeProvider.getAnvilRecipes(recipeFactory),
                VanillaRecipeCategoryUid.ANVIL);
        registration.addRecipes((Collection) DummyRecipeProvider.getCustomCraftingRecipes(recipeFactory),
