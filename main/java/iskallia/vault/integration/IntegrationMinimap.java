...
public class IntegrationMinimap {
    ...
    private static void setupConfigAccessors() throws Exception {
        final Object minimapInstance = ModList.get().getModObjectById("xaerominimap")
                .orElseThrow(IllegalStateException::new);
        final Object minimapSettings = minimapInstance.getClass().getMethod("getSettings", (Class<?>[]) new Class[0])
                .invoke(minimapInstance, new Object[0]);
