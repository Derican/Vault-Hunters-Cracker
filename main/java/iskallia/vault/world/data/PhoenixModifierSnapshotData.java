...
public class PhoenixModifierSnapshotData extends InventorySnapshotData {
    ...
    public static void onDeath(final LivingDeathEvent event) {
        ...
        if (currentRaid != null && !currentRaid
                .getActiveModifiersFor(PlayerFilter.of((PlayerEntity) player), InventoryRestoreModifier.class)
                .isEmpty()) {
            final PhoenixModifierSnapshotData data = get(world);
    ...
    public static PhoenixModifierSnapshotData get(final ServerWorld world) {
        return (PhoenixModifierSnapshotData) world.getServer().overworld().getDataStorage()
                .computeIfAbsent((Supplier) PhoenixModifierSnapshotData::new, "the_vault_PhoenixModifier");
    }
}
