...
public class RaidProperties implements INBTSerializable<CompoundNBT> {
    ...
    public <T, I extends VAttribute.Instance<T>> I getOrDefault(final VAttribute<T, I> attribute,
    ...
    public <T, I extends VAttribute.Instance<T>> T getBaseOrDefault(final VAttribute<T, I> attribute,
            final Supplier<T> value) {
        return attribute.getOrDefault(this.getData(), value).getBaseValue();
    }
    ...
    public <T, I extends VAttribute.Instance<T>> I getOrCreate(final VAttribute<T, I> attribute,
            final Supplier<T> value) {
        return attribute.getOrCreate(this.getData(), value);
    }
