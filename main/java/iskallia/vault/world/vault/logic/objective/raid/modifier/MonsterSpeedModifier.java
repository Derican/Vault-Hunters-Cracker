...
public class MonsterSpeedModifier extends RaidModifier {
    ...
    public void affectRaidMob(final MobEntity mob, final float value) {
        ...
        if (attr != null) {
            attr.addPermanentModifier(new AttributeModifier(MonsterSpeedModifier.MOB_SPEED_INCREASE, "Raid Mob Speed",
                    (double) value, AttributeModifier.Operation.MULTIPLY_BASE));
        }
    }
