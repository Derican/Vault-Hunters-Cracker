...
public class VotingSession {
    ...
    VotingSession(final CompoundNBT tag) {
        this.voted = new HashSet<String>();
        this.directions = new ArrayList<DirectionChoice>();
        this.stabilizerPos = CodecUtils.readNBT((com.mojang.serialization.Codec<BlockPos>) BlockPos.CODEC,
                tag, "pos", BlockPos.ZERO);
    ...
    public CompoundNBT serialize() {
        ...
        CodecUtils.writeNBT((com.mojang.serialization.Codec<BlockPos>) BlockPos.CODEC, this.stabilizerPos,
                tag, "pos");
