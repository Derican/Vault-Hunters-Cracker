...
public class FloatingItemPlacementModifier extends VoteModifier {
    ...
    public FloatingItemPlacementModifier(final String name, final String description,
            final int voteLockDurationChangeSeconds, final int blocksPerSpawn, final List<ItemStack> itemList) {
