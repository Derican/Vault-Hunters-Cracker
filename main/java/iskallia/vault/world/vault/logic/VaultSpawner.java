...
public class VaultSpawner implements INBTSerializable<CompoundNBT>, IVaultTask {
    ...
    protected void updateMobIds(final ServerWorld world, final ServerPlayerEntity player) {
        this.spawnedMobIds = this.spawnedMobIds.stream().map((Function<? super Object, ?>) world::getEntity)
                .filter(Objects::nonNull).filter(entity -> {
                ...
                }).map((Function<? super Object, ?>) Entity::getUUID)
                .collect((Collector<? super Object, ?, VListNBT<UUID, StringNBT>>) Collectors
                        .toCollection((Supplier<R>) VListNBT::ofUUID));
    }

    protected void attemptSpawn(final VaultRaid vault, final ServerWorld world, final VaultPlayer player,
            final Random random) {
        player.runIfPresent(world.getServer(), playerEntity -> {
            ...
            final LivingEntity spawned = spawnMob(vault, world, level, pos.getX() + x, pos.getY() + y,
                    pos.getZ() + z, random);
            if (spawned != null) {
    ...
    @Nullable
    public static LivingEntity spawnMob(final VaultRaid vault, final ServerWorld world, final int vaultLevel,
            final int x, final int y, final int z, final Random random) {
        ...
        entity.moveTo((double) (x + 0.5f), (double) (y + 0.2f), (double) (z + 0.5f),
                (float) (random.nextDouble() * 2.0 * 3.141592653589793), 0.0f);
        if (entity instanceof MobEntity) {
            ((MobEntity) entity).spawnAnim();
            ((MobEntity) entity).finalizeSpawn((IServerWorld) world,
                    new DifficultyInstance(Difficulty.PEACEFUL, 13000L, 0L, 0.0f), SpawnReason.STRUCTURE,
    ...
    public static class Config implements INBTSerializable<CompoundNBT> {
        ...
        public Config(final int startMaxMobs, final int extraMaxMobs, final double minDistance,
                final double maxDistance, final double despawnDistance) {
        ...
        public Config withStartMaxMobs(final int startMaxMobs) {
            return new Config(startMaxMobs, this.extraMaxMobs, this.minDistance, this.maxDistance,
                    this.despawnDistance);
        }

        public Config withExtraMaxMobs(final int extraMaxMobs) {
            return new Config(this.startMaxMobs, extraMaxMobs, this.minDistance, this.maxDistance,
                    this.despawnDistance);
        }

        public Config withMinDistance(final double minDistance) {
            return new Config(this.startMaxMobs, this.extraMaxMobs, minDistance, this.maxDistance,
                    this.despawnDistance);
        }

        public Config withMaxDistance(final double maxDistance) {
            return new Config(this.startMaxMobs, this.extraMaxMobs, this.minDistance, maxDistance,
                    this.despawnDistance);
        }

        public Config withDespawnDistance(final double despawnDistance) {
            return new Config(this.startMaxMobs, this.extraMaxMobs, this.minDistance, this.maxDistance,
                    despawnDistance);
        }

        public Config withStartMaxMobs(final IntUnaryOperator operator) {
            return new Config(operator.applyAsInt(this.startMaxMobs), this.extraMaxMobs, this.minDistance,
                    this.maxDistance, this.despawnDistance);
        }

        public Config withExtraMaxMobs(final IntUnaryOperator operator) {
            return new Config(this.startMaxMobs, operator.applyAsInt(this.extraMaxMobs), this.minDistance,
                    this.maxDistance, this.despawnDistance);
        }

        public Config withMinDistance(final DoubleUnaryOperator operator) {
            return new Config(this.startMaxMobs, this.extraMaxMobs, operator.applyAsDouble(this.minDistance),
                    this.maxDistance, this.despawnDistance);
        }

        public Config withMaxDistance(final DoubleUnaryOperator operator) {
            return new Config(this.startMaxMobs, this.extraMaxMobs, this.minDistance,
                    operator.applyAsDouble(this.maxDistance), this.despawnDistance);
        }

        public Config withDespawnDistance(final DoubleUnaryOperator operator) {
            return new Config(this.startMaxMobs, this.extraMaxMobs, this.minDistance, this.maxDistance,
                    operator.applyAsDouble(this.despawnDistance));
        }
        ...
        @Override
        public int hashCode() {
            return Objects.hash(this.getStartMaxMobs(), this.getExtraMaxMobs(), this.getMinDistance(),
                    this.getMaxDistance(), this.getDespawnDistance());
        }
