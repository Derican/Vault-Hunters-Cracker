...
public class VaultBossSpawner {
    public static LivingEntity spawnBoss(final VaultRaid vault, final ServerWorld world, final BlockPos pos) {
        ...
        VaultMobsConfig.Mob bossConfig = ModConfigs.VAULT_MOBS.getForLevel(level).BOSS_POOL
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            final LightningBoltEntity bolt = (LightningBoltEntity) EntityType.LIGHTNING_BOLT
                    .create((World) world);
