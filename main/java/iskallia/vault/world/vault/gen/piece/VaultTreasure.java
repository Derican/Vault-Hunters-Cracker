...
public class VaultTreasure extends VaultPiece {
    ...
    public VaultTreasure(final ResourceLocation template, final MutableBoundingBox boundingBox,
    ...
    public boolean isDoorOpen(final World world) {
        return BlockPos.betweenClosedStream(this.getBoundingBox()).map(world::getBlockState)
                ...
                .anyMatch(state -> (boolean) state.getValue((Property) VaultDoorBlock.OPEN));
    }
