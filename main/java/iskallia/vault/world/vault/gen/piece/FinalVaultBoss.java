...
public class FinalVaultBoss extends VaultPiece {
    ...
    protected FinalVaultBoss(final ResourceLocation id, final ResourceLocation template,
            final MutableBoundingBox boundingBox, final Rotation rotation) {
        super(id, template, boundingBox, rotation);
    }

    public FinalVaultBoss(final ResourceLocation template, final MutableBoundingBox boundingBox,
