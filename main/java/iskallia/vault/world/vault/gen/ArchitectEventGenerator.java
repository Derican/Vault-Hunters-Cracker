...
public class ArchitectEventGenerator extends VaultGenerator {
    ...
    public boolean generate(final ServerWorld world, final VaultRaid vault, final BlockPos.Mutable pos) {
        ...
        try {
            ...
            final StructureStart<?> start = ModFeatures.ARCHITECT_EVENT_FEATURE.generate(jigsaw, world.registryAccess(),
            ...
            world.getChunk(chunkPos.x, chunkPos.z, ChunkStatus.EMPTY, true)
                    .setStartForFeature((Structure) ModStructures.ARCHITECT_EVENT, (StructureStart) start);
