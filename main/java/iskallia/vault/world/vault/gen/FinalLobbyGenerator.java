...
public class FinalLobbyGenerator extends VaultGenerator {
    ...
    public boolean generate(final ServerWorld world, final VaultRaid vault, final BlockPos.Mutable pos) {
        ...
        try {
            ...
            final StructureStart<?> start = ModFeatures.FINAL_VAULT_LOBBY_FEATURE.generate(jigsaw,
                    world.registryAccess(), world.getChunkSource().generator, world.getStructureManager(), 0,
                    world.getSeed());
            ...
            world.getChunk(chunkPos.x, chunkPos.z, ChunkStatus.EMPTY, true)
                    .setStartForFeature((Structure) ModStructures.FINAL_VAULT_LOBBY, (StructureStart) start);
