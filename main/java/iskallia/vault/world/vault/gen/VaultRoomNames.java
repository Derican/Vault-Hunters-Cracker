...
public class VaultRoomNames {
    ...
    public static ITextComponent getName(final String filterKey) {
        switch (filterKey) {
            case "crystal_caves": {
                return (ITextComponent) new StringTextComponent("Crystal Cave")
                        .withStyle(TextFormatting.DARK_PURPLE);
            }
            case "contest_alien": {
                return (ITextComponent) new StringTextComponent("Contest: Alien")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_birdcage": {
                return (ITextComponent) new StringTextComponent("Contest: Ancient Temple")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_city": {
                return (ITextComponent) new StringTextComponent("Contest: City Streets")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_dragon": {
                return (ITextComponent) new StringTextComponent("Contest: Dragon")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_fishtank": {
                return (ITextComponent) new StringTextComponent("Contest: Aquarium")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_mine": {
                return (ITextComponent) new StringTextComponent("Contest: Mine")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_mustard": {
                return (ITextComponent) new StringTextComponent("Contest: Yellow Brick Road")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_oriental": {
                return (ITextComponent) new StringTextComponent("Contest: Oriental")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_pixel": {
                return (ITextComponent) new StringTextComponent("Contest: Pixelart")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_prismarine": {
                return (ITextComponent) new StringTextComponent("Contest: Atlantis")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_tree": {
                return (ITextComponent) new StringTextComponent("Contest: Tree")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "contest_web": {
                return (ITextComponent) new StringTextComponent("Contest: Spiderweb")
                        .withStyle(TextFormatting.DARK_AQUA);
            }
            case "digsite": {
            ...
            case "mushroom_forest": {
                return (ITextComponent) new StringTextComponent("Mushroom Forest")
