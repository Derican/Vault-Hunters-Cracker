...
public class VaultTroveGenerator extends VaultGenerator {
    ...
    public boolean generate(final ServerWorld world, final VaultRaid vault, final BlockPos.Mutable pos) {
        ...
        try {
            ...
            final StructureStart<?> start = ModFeatures.VAULT_TROVE_FEATURE.generate(jigsaw, world.registryAccess(),
            ...
            world.getChunk(chunkPos.x, chunkPos.z, ChunkStatus.EMPTY, true)
                    .setStartForFeature((Structure) ModStructures.VAULT_TROVE, (StructureStart) start);
