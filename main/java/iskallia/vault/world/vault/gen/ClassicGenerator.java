...
public class ClassicGenerator extends VaultGenerator
{
    ...
    public boolean generate(final ServerWorld world, final VaultRaid vault, final BlockPos.Mutable pos) {
        ...
        try {
            ...
            final List<StructurePiece> obeliskPieces = jigsaw.getGeneratedPieces().stream().filter((Predicate<? super Object>)this::isObjectivePiece).collect((Collector<? super Object, ?, List<StructurePiece>>)Collectors.toList());
