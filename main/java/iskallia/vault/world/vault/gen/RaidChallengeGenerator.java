...
public class RaidChallengeGenerator extends VaultGenerator {
    ...
    public boolean generate(final ServerWorld world, final VaultRaid vault, final BlockPos.Mutable pos) {
        ...
        try {
            ...
            final StructureStart<?> start = ModFeatures.RAID_CHALLENGE_FEATURE.generate(jigsaw, world.registryAccess(),
            ...
            world.getChunk(chunkPos.x, chunkPos.z, ChunkStatus.EMPTY, true)
                    .setStartForFeature((Structure) ModStructures.RAID_CHALLENGE, (StructureStart) start);
