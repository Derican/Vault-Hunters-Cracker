...
public class RaidChallengeFeature
        extends StructureFeature<RaidChallengeStructure.Config, Structure<RaidChallengeStructure.Config>> {
    public RaidChallengeFeature(final Structure<RaidChallengeStructure.Config> structure,
            final RaidChallengeStructure.Config config) {
    ...
    public StructureStart<?> generate(final JigsawGenerator jigsaw, final DynamicRegistries registry,
        ...
        final RaidChallengeStructure.Start start = (RaidChallengeStructure.Start) this.feature.getStartFactory()
