...
public class FinalVaultBossFeature
        extends StructureFeature<FinalVaultBossStructure.Config, Structure<FinalVaultBossStructure.Config>> {
    public FinalVaultBossFeature(final Structure<FinalVaultBossStructure.Config> p_i231937_1_,
            final FinalVaultBossStructure.Config p_i231937_2_) {
    ...
    public StructureStart<?> generate(final VaultJigsawGenerator jigsaw, final DynamicRegistries registry,
        ...
        final FinalVaultBossStructure.Start start = (FinalVaultBossStructure.Start) this.feature.getStartFactory()
