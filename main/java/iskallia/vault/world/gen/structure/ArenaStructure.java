...
public class ArenaStructure extends Structure<Config>
{
    ...
    public static class Pools
    {
        ...
        static {
            START = JigsawPatternRegistry.register(new JigsawPattern(Vault.id("arena/starts"), new ResourceLocation("empty"), (List)ImmutableList.of((Object)Pair.of((Object)JigsawPiece.single(Vault.sId("arena/arena1/p_p"), ProcessorLists.EMPTY), (Object)1)), JigsawPattern.PlacementBehaviour.RIGID));
        }
    }
}
