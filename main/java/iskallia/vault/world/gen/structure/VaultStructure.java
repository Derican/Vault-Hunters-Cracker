...
public class VaultStructure extends Structure<Config>
{
    ...
    public static class Config implements IFeatureConfig
    {
        ...
        static {
            CODEC = RecordCodecBuilder.create(builder -> builder.group((App)JigsawPattern.CODEC.fieldOf("start_pool").forGetter((Function)Config::getStartPool), (App)Codec.intRange(0, Integer.MAX_VALUE).fieldOf("size").forGetter((Function)Config::getSize)).apply((Applicative)builder, (BiFunction)Config::new));
        }
    }
    ...
    public static class Pools
    {
        ...
        static {
            FINAL_START = JigsawPatternRegistry.register(new JigsawPattern(Vault.id("final_vault/start"), new ResourceLocation("empty"), (List)ImmutableList.of((Object)Pair.of((Object)JigsawPiece.single(Vault.sId("final_vault/start"), ProcessorLists.EMPTY), (Object)1)), JigsawPattern.PlacementBehaviour.RIGID));
        }
    }
}
