...
public class VaultStructure extends Structure<Config> {
    ...
    public static class Start extends MarginedStructureStart<Config> {
        ...
        public Start(final VaultStructure structure, final int chunkX, final int chunkZ, final MutableBoundingBox box,
        ...
        public void generate(final VaultJigsawGenerator jigsaw, final DynamicRegistries registry,
            ...
            jigsaw.generate(registry,
                    new Config(() -> registry.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            .get(Vault.id("vault/starts")), 11).toVillageConfig(),
    ...
    public static class Pools {
        ...
        static {
            FINAL_START = JigsawPatternRegistry.register(new JigsawPattern(Vault.id("final_vault/start"),
                    new ResourceLocation("empty"),
                    (List) ImmutableList.of((Object) Pair.of((Object) JigsawPiece
                            .single(Vault.sId("final_vault/start"), ProcessorLists.EMPTY), (Object) 1)),
