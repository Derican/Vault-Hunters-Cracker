...
public class VaultTroveStructure extends Structure<Config>
{
    ...
    public static class Pools
    {
        ...
        static {
            START = JigsawPatternRegistry.register(new JigsawPattern(Vault.id("trove/starts"), new ResourceLocation("empty"), (List)ImmutableList.of((Object)Pair.of((Object)JigsawPiece.single(Vault.sId("trove/starts"), ProcessorLists.EMPTY), (Object)1)), JigsawPattern.PlacementBehaviour.RIGID));
        }
    }
}
