...
public class FinalVaultLobbyStructure extends Structure<Config> {
    ...
    public static class Start extends MarginedStructureStart<Config> {
        ...
        public Start(final FinalVaultLobbyStructure structure, final int chunkX, final int chunkZ,
        ...
        public void generate(final VaultJigsawGenerator jigsaw, final DynamicRegistries registry,
            ...
            jigsaw.generate(registry,
                    new VaultStructure.Config(() -> registry.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            .get(Vault.id("final_vault/starts")), 1).toVillageConfig(),
    ...
    public static class Pools {
        ...
        static {
            START = JigsawPatternRegistry
                    .register(new JigsawPattern(Vault.id("final_vault/starts"), new ResourceLocation("empty"),
                            (List) ImmutableList.of(
                                    (Object) Pair.of((Object) JigsawPiece.single(Vault.sId("final_vault/starts"),
                                            ProcessorLists.EMPTY), (Object) 1)),
