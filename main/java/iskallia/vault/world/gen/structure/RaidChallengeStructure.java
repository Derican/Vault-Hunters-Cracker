...
public class RaidChallengeStructure extends Structure<Config> {
    ...
    public static class Start extends MarginedStructureStart<Config> {
        ...
        public Start(final RaidChallengeStructure structure, final int chunkX, final int chunkZ,
        ...
        public void generate(final JigsawGenerator jigsaw, final DynamicRegistries registry, final ChunkGenerator gen,
            ...
            jigsaw.generate(registry,
                    new VaultStructure.Config(() -> registry.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            .get(Vault.id("raid/starts")), 1).toVillageConfig(),
    ...
    public static class Pools {
        ...
        static {
            START = JigsawPatternRegistry.register(new JigsawPattern(Vault.id("raid/starts"),
                    new ResourceLocation("empty"),
                    (List) ImmutableList.of((Object) Pair.of(
                            (Object) JigsawPiece.single(Vault.sId("raid/starts"), ProcessorLists.EMPTY),
                            (Object) 1)),
