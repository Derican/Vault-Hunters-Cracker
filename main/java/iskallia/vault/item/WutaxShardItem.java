...
public class WutaxShardItem extends Item {
    ...
    public void appendHoverText(final ItemStack stack, @Nullable final World worldIn, final List<ITextComponent> tooltip,
        ...
        tooltip.add((ITextComponent) new StringTextComponent("Reduces the level requirement of")
                .withStyle(TextFormatting.GRAY));
        tooltip.add((ITextComponent) new StringTextComponent("any vault gear by 1 when combined")
                .withStyle(TextFormatting.GRAY));
        tooltip.add((ITextComponent) new StringTextComponent("in an anvil with a vault gear item.")
                .withStyle(TextFormatting.GRAY));
