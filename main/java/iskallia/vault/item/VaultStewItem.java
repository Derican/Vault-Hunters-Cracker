...
public class VaultStewItem extends SoupItem {
    ...
    public ActionResult<ItemStack> use(final World world, final PlayerEntity player, final Hand hand) {
        if (!world.isClientSide && this.getRarity() == Rarity.MYSTERY) {
            ...
            final ItemStack stackToDrop = new ItemStack((IItemProvider) Registry.ITEM
                    .getOptional(new ResourceLocation(randomPart)).orElse(Items.AIR));
    ...
    static {
        VaultStewItem.FOOD = new Food.Builder().saturationMod(0.0f).nutrition(0).fast().alwaysEat()
                .build();
    }
