...
public class VaultArmorItem extends DyeableArmorItem implements VaultGear<VaultArmorItem> {
    ...
    public int getModelsFor(final Rarity rarity) {
        return (rarity == Rarity.SCRAPPY) ? ModModels.GearModel.SCRAPPY_REGISTRY.size()
                : ModModels.GearModel.REGISTRY.size();
    }
    ...
    public ActionResult<ItemStack> use(final World world, final PlayerEntity player, final Hand hand) {
        ...
        return this.onItemRightClick(this, world, player, hand,
                (ActionResult<ItemStack>) (this.canEquip(heldStack, slot, (Entity) player)
                        ? super.use(world, player, hand)
                        : ActionResult.fail((Object) heldStack)));
    }
    ...
    @OnlyIn(Dist.CLIENT)
    public void appendHoverText(final ItemStack itemStack, final World world, final List<ITextComponent> tooltip,
    ...
    @Nullable
    @OnlyIn(Dist.CLIENT)
    public <A extends BipedModel<?>> A getArmorModel(final LivingEntity entityLiving, final ItemStack itemStack,
            final EquipmentSlotType armorSlot, final A _default) {
        return this.getArmorModel(this, entityLiving, itemStack, armorSlot, _default);
    }

    @Nullable
    @OnlyIn(Dist.CLIENT)
    public String getArmorTexture(final ItemStack itemStack, final Entity entity, final EquipmentSlotType slot,
            final String type) {
