...
public class OtherSideData implements INBTSerializable<CompoundNBT> {
    ...
    public CompoundNBT serializeNBT() {
        ...
        nbt.putIntArray("LinkedPos", new int[] { this.linkedPos.getX(), this.linkedPos.getY(),
                this.linkedPos.getZ() });
    ...
    public void deserializeNBT(final CompoundNBT nbt) {
        ...
        this.linkedDim = (RegistryKey<World>) RegistryKey.create(Registry.DIMENSION_REGISTRY,
                new ResourceLocation(nbt.getString("LinkedDim")));
    }
}
