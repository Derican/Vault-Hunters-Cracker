...
public class FighterRenderer extends LivingRenderer<FighterEntity, FighterModel> {
    ...
    public FighterRenderer(final EntityRendererManager renderManager, final boolean useSmallArms) {
        super(renderManager, (EntityModel) new FighterModel(0.0f, useSmallArms), 0.5f);
    ...
    protected void preRenderCallback(final FighterEntity entity, final MatrixStack matrixStack,
            final float partialTickTime) {
        final float f = entity.sizeMultiplier;
        matrixStack.scale(f, f, f);
    }

    public void render(final FighterEntity entity, final float entityYaw, final float partialTicks,
    ...
    public ResourceLocation getEntityTexture(final FighterEntity entity) {
    ...
    protected void renderName(final FighterEntity entityIn, final ITextComponent displayNameIn,
    ...
    public void renderRightArm(final MatrixStack matrixStackIn, final IRenderTypeBuffer bufferIn,
            final int combinedLightIn, final FighterEntity playerIn) {
        this.renderItem(matrixStackIn, bufferIn, combinedLightIn, playerIn,
                ((FighterModel) this.model).rightArm, ((FighterModel) this.model).rightSleeve);
    }

    public void renderLeftArm(final MatrixStack matrixStackIn, final IRenderTypeBuffer bufferIn,
            final int combinedLightIn, final FighterEntity playerIn) {
        this.renderItem(matrixStackIn, bufferIn, combinedLightIn, playerIn,
                ((FighterModel) this.model).leftArm, ((FighterModel) this.model).leftSleeve);
    }

    private void renderItem(final MatrixStack matrixStackIn, final IRenderTypeBuffer buffer, final int combinedLight,
            final FighterEntity entity, final ModelRenderer rendererArm, final ModelRenderer rendererArmWear) {
        final FighterModel playermodel = (FighterModel) this.getModel();
        this.setModelVisibilities(entity);
    ...
    protected void applyRotations(final FighterEntity entityLiving, final MatrixStack matrixStack,
