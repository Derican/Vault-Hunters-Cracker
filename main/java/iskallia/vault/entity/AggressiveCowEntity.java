...
public class AggressiveCowEntity extends CowEntity {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(0, (Goal) new NearestAttackableTargetGoal((MobEntity) this,
                (Class) PlayerEntity.class, 0, true, false, (Predicate) null));
    }
    ...
    public boolean isInvulnerableTo(final DamageSource source) {
        return super.isInvulnerableTo(source) || source == DamageSource.FALL
