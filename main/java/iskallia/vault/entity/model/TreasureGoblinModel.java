...
public class TreasureGoblinModel extends PlayerModel<TreasureGoblinEntity> {
    public TreasureGoblinModel() {
        ...
        (this.rightArm = new ModelRenderer((Model) this, 40, 16)).addBox(-3.0f, -2.0f, -2.0f, 4.0f, 12.0f,
                4.0f);
        ...
        (this.rightLeg = new ModelRenderer((Model) this, 0, 16)).addBox(-2.0f, 0.0f, -2.0f, 4.0f, 12.0f,
                4.0f);
    ...
    public void setRotationAngles(final TreasureGoblinEntity entity, final float limbSwing, final float limbSwingAmount,
            final float ageInTicks, final float netbipedHeadYaw, final float bipedHeadPitch) {
        super.setupAnim((LivingEntity) entity, limbSwing, limbSwingAmount, ageInTicks, netbipedHeadYaw,
                bipedHeadPitch);
    }
