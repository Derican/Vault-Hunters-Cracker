...
public class EyestalkModel extends SegmentedModel<EyestalkEntity>
{
    ...
    public void setRotationAngles(@Nonnull final EyestalkEntity entity, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch) {
