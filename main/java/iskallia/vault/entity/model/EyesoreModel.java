...
public class EyesoreModel extends SegmentedModel<EyesoreEntity> {
    ...
    public EyesoreModel() {
        ...
        this.tentacles_1_r1.texOffs(63, 65).addBox(-1.5f, -2.4659f, -1.2412f, 3.0f, 3.0f, 3.0f, 0.0f,
                false);
        ...
        this.tentacles_2_r1.texOffs(24, 65).addBox(-1.5f, -2.2599f, -2.6927f, 3.0f, 3.0f, 3.0f, 0.0f,
                false);
        ...
        this.tentacles_3_r1.texOffs(64, 22).addBox(-1.7588f, -2.4659f, -1.5f, 3.0f, 3.0f, 3.0f, 0.0f,
                false);
        ...
        this.tentacles_4_r1.texOffs(63, 10).addBox(-1.3264f, -2.4848f, -1.5f, 3.0f, 3.0f, 3.0f, 0.0f,
                false);
        ...
        this.tentacles_5_r1.texOffs(63, 59).addBox(-1.4564f, -2.6918f, -2.2601f, 3.0f, 3.0f, 3.0f, 0.0f,
                false);
        ...
        this.tentacles_6_r1.texOffs(64, 16).addBox(-1.7588f, -2.4623f, -1.4158f, 3.0f, 3.0f, 3.0f, 0.0f,
                false);
        ...
        this.tentacles_7_r1.texOffs(63, 4).addBox(-1.2412f, -2.4659f, -1.5f, 3.0f, 3.0f, 3.0f, 0.0f,
                false);
        ...
        this.tentacles_8_r1.texOffs(54, 62).addBox(-1.5f, -2.4537f, -1.8007f, 3.0f, 3.0f, 3.0f, 0.0f,
                false);
        ...
        this.tentacles_9_r1.texOffs(62, 35).addBox(-1.7164f, -2.4615f, -1.6695f, 3.0f, 3.0f, 3.0f, 0.0f,
                false);
    ...
    public void setRotationAngles(@Nonnull final EyesoreEntity entity, final float limbSwing,
