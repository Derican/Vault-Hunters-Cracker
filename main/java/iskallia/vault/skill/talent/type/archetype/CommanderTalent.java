...
public class CommanderTalent extends ArchetypeTalent {
    ...
    public CommanderTalent(final int cost, final float damageTakenMultiplier, final float damageDealtMultiplier,
            final float summonEternalAdditionalCooldownReduction, final float summonEternalDamageDealtMultiplier,
            final boolean doEternalsUnaliveWhenDead) {
        super(cost);
    ...
    public static void onPlayerTick(final TickEvent.PlayerTickEvent event) {
        ...
        if (talents.hasLearnedNode(ModConfigs.TALENTS.COMMANDER)
            ...
            final float damageMultiplier = talents.getNodeOf(ModConfigs.TALENTS.COMMANDER).getTalent()
