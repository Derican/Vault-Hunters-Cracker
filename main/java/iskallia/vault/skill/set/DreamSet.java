...
public class DreamSet extends EffectSet {
    ...
    public DreamSet(final float increasedDamage, final int hasteAddition, final float increasedResistance,
            final float increasedParry, final float increasedChestRarity) {
        super(VaultGear.Set.DREAM, Effects.DIG_SPEED, hasteAddition, EffectTalent.Type.HIDDEN,
