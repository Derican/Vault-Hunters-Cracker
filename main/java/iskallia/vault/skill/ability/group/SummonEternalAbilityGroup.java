...
public class SummonEternalAbilityGroup
    ...
    public static SummonEternalAbilityGroup defaultConfig() {
        ...
        ((AbilityGroup<SummonEternalConfig, E>) group)
                .addLevel(new SummonEternalConfig(1, 12000, 1, 3, 12000, 0.2f, true));
        ((AbilityGroup<SummonEternalConfig, E>) group)
                .addLevel(new SummonEternalConfig(1, 10800, 1, 3, 10800, 0.2f, true));
        ((AbilityGroup<SummonEternalConfig, E>) group)
                .addLevel(new SummonEternalConfig(1, 9600, 1, 3, 9600, 0.2f, false));
        ((AbilityGroup<SummonEternalConfig, E>) group)
                .addLevel(new SummonEternalConfig(1, 8400, 1, 3, 8400, 0.2f, false));
        ((AbilityGroup<SummonEternalConfig, E>) group)
                .addLevel(new SummonEternalConfig(1, 7200, 1, 3, 7200, 0.2f, false));
        ...
        group.debuffLevelConfiguration
                .add(new SummonEternalDebuffConfig(1, 12000, 1, 3, 12000, true, 0.2f, 0.1f, 20, 0));
        group.debuffLevelConfiguration
                .add(new SummonEternalDebuffConfig(1, 10800, 1, 3, 10800, true, 0.2f, 0.2f, 30, 0));
        group.debuffLevelConfiguration
                .add(new SummonEternalDebuffConfig(1, 9600, 1, 3, 9600, false, 0.2f, 0.3f, 40, 1));
        group.debuffLevelConfiguration
                .add(new SummonEternalDebuffConfig(1, 8400, 1, 3, 8400, false, 0.2f, 0.4f, 60, 1));
        group.debuffLevelConfiguration
                .add(new SummonEternalDebuffConfig(1, 7200, 1, 3, 7200, false, 0.2f, 0.5f, 80, 1));
