...
public class SummonEternalConfig extends AbilityConfig {
    ...
    public SummonEternalConfig(final int cost, final int cooldown, final int numberOfEternals,
            final int summonedEternalsCap, final int despawnTime, final float ancientChance, final boolean vaultOnly) {
