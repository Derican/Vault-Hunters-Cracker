...
public class MegaJumpDamageConfig extends MegaJumpConfig {
    ...
    public MegaJumpDamageConfig(final int cost, final int extraHeight, final float radius,
            final float percentAttackDamageDealt, final float knockbackStrengthMultiplier) {
