...
public class GhostWalkRegenerationConfig extends GhostWalkConfig {
    ...
    public GhostWalkRegenerationConfig(final int cost, final int level, final int durationTicks,
            final int regenAmplifier) {
    ...
    public EffectTalent makeRegenerationTalent() {
        return new EffectTalent(0, Effects.REGENERATION, this.getRegenAmplifier(), this.getRegenerationType(),
