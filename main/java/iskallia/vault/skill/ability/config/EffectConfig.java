...
public class EffectConfig extends AbilityConfig {
    ...
    public EffectConfig(final int cost, final Effect effect, final int amplifier, final Type type,
    ...
    public EffectConfig(final int cost, final Effect effect, final int amplifier, final Type type,
            final Behavior behavior, final int cooldown) {
        this(cost, Registry.MOB_EFFECT.getKey((Object) effect).toString(), amplifier, type.toString(),
                behavior, cooldown);
    }

    public EffectConfig(final int cost, final String effect, final int amplifier, final String type,
            final Behavior behavior) {
