...
public class ModBlocks {
    ...
    public static void registerTileEntities(final RegistryEvent.Register<TileEntityType<?>> event) {
        ...
        registerTileEntity(event, ModBlocks.VAULT_CHAMPION_TROPHY_TILE_ENTITY,
                Vault.id("vault_champion_trophy_tile_entity"));
        ...
        registerTileEntity(event, ModBlocks.ADVANCED_VENDING_MACHINE_TILE_ENTITY,
                Vault.id("advanced_vending_machine_tile_entity"));
        ...
        registerTileEntity(event, ModBlocks.ANCIENT_CRYO_CHAMBER_TILE_ENTITY,
                Vault.id("ancient_cryo_chamber_tile_entity"));
        ...
        registerTileEntity(event, ModBlocks.VAULT_TREASURE_CHEST_TILE_ENTITY,
                Vault.id("vault_treasure_chest_tile_entity"));
        ...
        registerTileEntity(event, ModBlocks.CATALYST_DECRYPTION_TABLE_TILE_ENTITY,
                Vault.id("catalyst_decryption_table_tile_entity"));
        registerTileEntity(event, ModBlocks.ETCHING_CONTROLLER_TILE_ENTITY,
                Vault.id("etching_vendor_controller_tile_entity"));
        registerTileEntity(event, ModBlocks.VAULT_CHARM_CONTROLLER_TILE_ENTITY,
                Vault.id("vault_charm_controller_tile_entity"));
        registerTileEntity(event, ModBlocks.RAID_CONTROLLER_TILE_ENTITY, Vault.id("raid_controller_tile_entity"));
    }

    public static void registerTileEntityRenderers() {
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.FLOATING_TEXT_TILE_ENTITY,
                (Function) FloatingTextRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.VAULT_CHAMPION_TROPHY_TILE_ENTITY,
                (Function) VaultChampionTrophyRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.FINAL_VAULT_FRAME_TILE_ENTITY,
                (Function) FinalVaultFrameRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.VAULT_ALTAR_TILE_ENTITY,
                (Function) VaultAltarRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.VAULT_RUNE_TILE_ENTITY,
                (Function) VaultRuneRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.VENDING_MACHINE_TILE_ENTITY,
                (Function) VendingMachineRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.ADVANCED_VENDING_MACHINE_TILE_ENTITY,
                (Function) AdvancedVendingRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.RELIC_STATUE_TILE_ENTITY,
                (Function) RelicStatueRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.LOOT_STATUE_TILE_ENTITY,
                (Function) LootStatueRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.TROPHY_STATUE_TILE_ENTITY,
                (Function) LootStatueRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.CRYO_CHAMBER_TILE_ENTITY,
                (Function) CryoChamberRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.ANCIENT_CRYO_CHAMBER_TILE_ENTITY,
                (Function) CryoChamberRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.VAULT_CHEST_TILE_ENTITY,
                (Function) VaultChestRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.VAULT_TREASURE_CHEST_TILE_ENTITY,
                (Function) VaultChestRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.XP_ALTAR_TILE_ENTITY,
                (Function) FillableAltarRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.BLOOD_ALTAR_TILE_ENTITY,
                (Function) FillableAltarRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.TIME_ALTAR_TILE_ENTITY,
                (Function) FillableAltarRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.SOUL_ALTAR_TILE_ENTITY,
                (Function) FillableAltarRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.STATUE_CAULDRON_TILE_ENTITY,
                (Function) StatueCauldronRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.HOURGLASS_TILE_ENTITY,
                (Function) HourglassRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.SCAVENGER_CHEST_TILE_ENTITY,
                (Function) ScavengerChestRenderer::new);
        ClientRegistry.bindTileEntityRenderer((TileEntityType) ModBlocks.RAID_CONTROLLER_TILE_ENTITY,
                (Function) VaultRaidControllerRenderer::new);
    }
    ...
    private static void registerBlock(final RegistryEvent.Register<Block> event, final Block block,
            final ResourceLocation id) {
        block.setRegistryName(id);
        event.getRegistry().register((IForgeRegistryEntry) block);
    }

    private static <T extends TileEntity> void registerTileEntity(final RegistryEvent.Register<TileEntityType<?>> event,
            final TileEntityType<?> type, final ResourceLocation id) {
        type.setRegistryName(id);
        event.getRegistry().register((IForgeRegistryEntry) type);
    }

    private static void registerBlockItemWithEffect(final RegistryEvent.Register<Item> event, final Block block,
            final int maxStackSize, final Consumer<Item.Properties> adjustProperties) {
        final Item.Properties properties = new Item.Properties().tab(ModItems.VAULT_MOD_GROUP)
    ...
    private static void registerTallBlockItem(final RegistryEvent.Register<Item> event, final Block block) {
        final TallBlockItem tallBlockItem = new TallBlockItem(block,
    ...
    static {
        ...
        VAULT_STONE = new Block(AbstractBlock.Properties.of(Material.STONE)
                .strength(1.5f, 6.0f).isValidSpawn((a, b, c, d) -> false));
        VAULT_GLASS = new GlassBlock(AbstractBlock.Properties.copy((AbstractBlock) Blocks.GLASS)
        ...
        YELLOW_PUZZLE_CONCRETE = new Block(
                AbstractBlock.Properties.copy((AbstractBlock) Blocks.BLACK_CONCRETE));
        PINK_PUZZLE_CONCRETE = new Block(
                AbstractBlock.Properties.copy((AbstractBlock) Blocks.BLACK_CONCRETE));
        GREEN_PUZZLE_CONCRETE = new Block(
                AbstractBlock.Properties.copy((AbstractBlock) Blocks.BLACK_CONCRETE));
        BLUE_PUZZLE_CONCRETE = new Block(
                AbstractBlock.Properties.copy((AbstractBlock) Blocks.BLACK_CONCRETE));
        ...
        VAULT_CHEST = (Block) new VaultChestBlock(AbstractBlock.Properties
                .copy((AbstractBlock) Blocks.CHEST).strength(40.0f, 5.0f));
        VAULT_TREASURE_CHEST = (Block) new VaultTreasureChestBlock(AbstractBlock.Properties
                .copy((AbstractBlock) Blocks.CHEST).strength(-1.0f, 3600000.0f));
        VAULT_ALTAR_CHEST = (Block) new VaultChestBlock(AbstractBlock.Properties
                .copy((AbstractBlock) Blocks.CHEST).strength(-1.0f, 3600000.0f));
        VAULT_COOP_CHEST = (Block) new VaultChestBlock(AbstractBlock.Properties.of(Material.STONE)
                .strength(2.0f, 3600000.0f).sound(SoundType.STONE));
        VAULT_BONUS_CHEST = (Block) new VaultChestBlock(AbstractBlock.Properties.of(Material.STONE)
                .strength(2.0f, 3600000.0f).sound(SoundType.STONE));
        ...
        SCAVENGER_CHEST = new ScavengerChestBlock(AbstractBlock.Properties
                .copy((AbstractBlock) Blocks.CHEST).strength(-1.0f, 3600000.0f));
        ...
        VAULT_AIR = new AirBlock(AbstractBlock.Properties.of(Material.AIR).noCollission()
                .noDrops().air());
        STABILIZER_COMPASS = new StabilizerCompassBlock();
        VOID_LIQUID_BLOCK = new VoidFluidBlock((Supplier<? extends VoidFluid>) ModFluids.VOID_LIQUID,
                AbstractBlock.Properties.of(Material.WATER, MaterialColor.COLOR_BLACK)
                        .noCollission().randomTicks().strength(100.0f).lightLevel(state -> 15)
                        .noDrops());
        ...
        VAULT_PLAYER_LOOT_STATUE_BLOCK_ITEM = new LootStatueBlockItem(ModBlocks.VAULT_PLAYER_LOOT_STATUE,
                StatueType.VAULT_BOSS);
        OMEGA_STATUE_BLOCK_ITEM = new LootStatueBlockItem(ModBlocks.OMEGA_STATUE, StatueType.OMEGA);
        OMEGA_STATUE_VARIANT_BLOCK_ITEM = new LootStatueBlockItem(ModBlocks.OMEGA_STATUE_VARIANT,
        ...
        PUZZLE_RUNE_BLOCK_ITEM = new PuzzleRuneBlock.Item(ModBlocks.PUZZLE_RUNE_BLOCK,
                new Item.Properties().tab(ModItems.VAULT_MOD_GROUP).stacksTo(1));
        VAULT_CHEST_ITEM = new BlockItem(ModBlocks.VAULT_CHEST, new Item.Properties()
                .tab(ModItems.VAULT_MOD_GROUP).setISTER(() -> VaultStackRendererProvider.INSTANCE));
        VAULT_TREASURE_CHEST_ITEM = new BlockItem(ModBlocks.VAULT_TREASURE_CHEST, new Item.Properties()
                .tab(ModItems.VAULT_MOD_GROUP).setISTER(() -> VaultStackRendererProvider.INSTANCE));
        VAULT_ALTAR_CHEST_ITEM = new BlockItem(ModBlocks.VAULT_ALTAR_CHEST, new Item.Properties()
                .tab(ModItems.VAULT_MOD_GROUP).setISTER(() -> VaultStackRendererProvider.INSTANCE));
        VAULT_COOP_CHEST_ITEM = new BlockItem(ModBlocks.VAULT_COOP_CHEST, new Item.Properties()
                .tab(ModItems.VAULT_MOD_GROUP).setISTER(() -> VaultStackRendererProvider.INSTANCE));
        VAULT_BONUS_CHEST_ITEM = new BlockItem(ModBlocks.VAULT_BONUS_CHEST, new Item.Properties()
                .tab(ModItems.VAULT_MOD_GROUP).setISTER(() -> VaultStackRendererProvider.INSTANCE));
        SCAVENGER_CHEST_ITEM = new BlockItem((Block) ModBlocks.SCAVENGER_CHEST, new Item.Properties()
                .tab(ModItems.VAULT_MOD_GROUP).setISTER(() -> VaultStackRendererProvider.INSTANCE));
        FLOATING_TEXT_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) FloatingTextTileEntity::new, new Block[] { (Block) ModBlocks.FLOATING_TEXT })
                .build((Type) null);
        VAULT_ALTAR_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultAltarTileEntity::new, new Block[] { ModBlocks.VAULT_ALTAR })
                .build((Type) null);
        VAULT_CHAMPION_TROPHY_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultChampionTrophyTileEntity::new,
                        new Block[] { ModBlocks.VAULT_CHAMPION_TROPHY })
                .build((Type) null);
        FINAL_VAULT_FRAME_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) FinalVaultFrameTileEntity::new, new Block[] { ModBlocks.FINAL_VAULT_FRAME })
                .build((Type) null);
        VAULT_RUNE_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultRuneTileEntity::new, new Block[] { ModBlocks.VAULT_RUNE_BLOCK })
                .build((Type) null);
        VAULT_CRATE_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultCrateTileEntity::new, new Block[] { ModBlocks.VAULT_CRATE,
                        ModBlocks.VAULT_CRATE_CAKE, ModBlocks.VAULT_CRATE_ARENA, ModBlocks.VAULT_CRATE_SCAVENGER })
                .build((Type) null);
        VAULT_PORTAL_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultPortalTileEntity::new, new Block[] { (Block) ModBlocks.VAULT_PORTAL })
                .build((Type) null);
        OTHER_SIDE_PORTAL_TILE_ENTITY = TileEntityType.Builder.of((Supplier) OtherSidePortalTileEntity::new,
                new Block[] { (Block) ModBlocks.OTHER_SIDE_PORTAL }).build((Type) null);
        VENDING_MACHINE_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VendingMachineTileEntity::new, new Block[] { ModBlocks.VENDING_MACHINE })
                .build((Type) null);
        ADVANCED_VENDING_MACHINE_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) AdvancedVendingTileEntity::new,
                        new Block[] { ModBlocks.ADVANCED_VENDING_MACHINE })
                .build((Type) null);
        RELIC_STATUE_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) RelicStatueTileEntity::new, new Block[] { ModBlocks.RELIC_STATUE })
                .build((Type) null);
        LOOT_STATUE_TILE_ENTITY = TileEntityType.Builder.of((Supplier) LootStatueTileEntity::new,
                new Block[] { ModBlocks.GIFT_NORMAL_STATUE, ModBlocks.GIFT_MEGA_STATUE,
                        ModBlocks.VAULT_PLAYER_LOOT_STATUE, ModBlocks.OMEGA_STATUE, ModBlocks.OMEGA_STATUE_VARIANT })
                .build((Type) null);
        TROPHY_STATUE_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) TrophyStatueTileEntity::new, new Block[] { ModBlocks.TROPHY_STATUE })
                .build((Type) null);
        CRYO_CHAMBER_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) CryoChamberTileEntity::new, new Block[] { ModBlocks.CRYO_CHAMBER })
                .build((Type) null);
        ANCIENT_CRYO_CHAMBER_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) AncientCryoChamberTileEntity::new, new Block[] { ModBlocks.CRYO_CHAMBER })
                .build((Type) null);
        VAULT_DOOR_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultDoorTileEntity::new,
                        new Block[] { (Block) ModBlocks.ISKALLIUM_DOOR, (Block) ModBlocks.GORGINITE_DOOR,
                                (Block) ModBlocks.SPARKLETINE_DOOR, (Block) ModBlocks.ASHIUM_DOOR,
                                (Block) ModBlocks.BOMIGNITE_DOOR, (Block) ModBlocks.FUNSOIDE_DOOR,
                                (Block) ModBlocks.TUBIUM_DOOR, (Block) ModBlocks.UPALINE_DOOR,
                                (Block) ModBlocks.PUFFIUM_DOOR, (Block) ModBlocks.UNKNOWN_DOOR })
                .build((Type) null);
        VAULT_LOOTABLE_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultLootableTileEntity::new,
                        new Block[] { ModBlocks.UNKNOWN_ORE, ModBlocks.VAULT_LOOT_RICHITY,
                                ModBlocks.VAULT_LOOT_RESOURCE, ModBlocks.VAULT_LOOT_MISC, ModBlocks.UNKNOWN_VAULT_CHEST,
                                ModBlocks.UNKNOWN_TREASURE_CHEST, ModBlocks.UNKNOWN_VAULT_OBJECTIVE })
                .build((Type) null);
        VAULT_CHEST_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultChestTileEntity::new, new Block[] { ModBlocks.VAULT_CHEST,
                        ModBlocks.VAULT_ALTAR_CHEST, ModBlocks.VAULT_COOP_CHEST, ModBlocks.VAULT_BONUS_CHEST })
                .build((Type) null);
        VAULT_TREASURE_CHEST_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultTreasureChestTileEntity::new,
                        new Block[] { ModBlocks.VAULT_TREASURE_CHEST })
                .build((Type) null);
        XP_ALTAR_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) XpAltarTileEntity::new, new Block[] { ModBlocks.XP_ALTAR })
                .build((Type) null);
        BLOOD_ALTAR_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) BloodAltarTileEntity::new, new Block[] { ModBlocks.BLOOD_ALTAR })
                .build((Type) null);
        TIME_ALTAR_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) TimeAltarTileEntity::new, new Block[] { ModBlocks.TIME_ALTAR })
                .build((Type) null);
        SOUL_ALTAR_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) SoulAltarTileEntity::new, new Block[] { ModBlocks.SOUL_ALTAR })
                .build((Type) null);
        STATUE_CAULDRON_TILE_ENTITY = TileEntityType.Builder.of((Supplier) StatueCauldronTileEntity::new,
                new Block[] { (Block) ModBlocks.STATUE_CAULDRON }).build((Type) null);
        OBELISK_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) ObeliskTileEntity::new, new Block[] { ModBlocks.OBELISK })
                .build((Type) null);
        HOURGLASS_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) HourglassTileEntity::new, new Block[] { ModBlocks.HOURGLASS })
                .build((Type) null);
        SCAVENGER_CHEST_TILE_ENTITY = TileEntityType.Builder.of((Supplier) ScavengerChestTileEntity::new,
                new Block[] { (Block) ModBlocks.SCAVENGER_CHEST }).build((Type) null);
        SCAVENGER_TREASURE_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) ScavengerTreasureTileEntity::new,
                        new Block[] { (Block) ModBlocks.SCAVENGER_TREASURE })
                .build((Type) null);
        STABILIZER_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) StabilizerTileEntity::new, new Block[] { ModBlocks.STABILIZER })
                .build((Type) null);
        CATALYST_DECRYPTION_TABLE_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) CatalystDecryptionTableTileEntity::new,
                        new Block[] { ModBlocks.CATALYST_DECRYPTION_TABLE })
                .build((Type) null);
        ETCHING_CONTROLLER_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) EtchingVendorControllerTileEntity::new,
                        new Block[] { (Block) ModBlocks.ETCHING_CONTROLLER_BLOCK })
                .build((Type) null);
        VAULT_CHARM_CONTROLLER_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultCharmControllerTileEntity::new,
                        new Block[] { ModBlocks.VAULT_CHARM_CONTROLLER_BLOCK })
                .build((Type) null);
        RAID_CONTROLLER_TILE_ENTITY = TileEntityType.Builder
                .of((Supplier) VaultRaidControllerTileEntity::new,
                        new Block[] { ModBlocks.RAID_CONTROLLER_BLOCK })
                .build((Type) null);
    }
