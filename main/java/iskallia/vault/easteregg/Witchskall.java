...
public class Witchskall {
    ...
    public static void onWitchTick(final LivingEvent.LivingUpdateEvent event) {
        ...
        if (setWitchskallTicks == 0) {
            ...
            serverWorld.sendParticles((IParticleData) ModParticles.GREEN_FLAME.get(), entity.getX(),
                    entity.getY(), entity.getZ(), 100, 0.5, 1.0, 0.5, 0.1);
            serverWorld.playSound((PlayerEntity) null, entity.getX(), entity.getY(),
                    entity.getZ(), ModSounds.WITCHSKALL_IDLE, SoundCategory.MASTER, 1.1f, 1.0f);
    ...
    public static void onWitchskallDrops(final LivingDropsEvent event) {
        ...
        final ItemEntity itemEntity = new ItemEntity((World) world, entity.getX(), entity.getY(),
                entity.getZ(), itemStack);
