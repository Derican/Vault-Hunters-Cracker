...
public class RaidModifierConfig extends Config {
    ...
    public Optional<RollableModifier> getRandomModifier(final int level, final boolean positive,
            final boolean preventArtifacts) {
    ...
    protected void reset() {
        ...
        (this.positiveLevels = new ArrayList<Level>()).add(new Level(0,
        ...
        (this.negativeLevels = new ArrayList<Level>()).add(new Level(0,
                new WeightedList<RollableModifier>().add(new RollableModifier("monsterAmount", 0.15f, 0.25f), 1)
