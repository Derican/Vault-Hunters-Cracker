...
public class VaultGearCraftingScalingConfig extends Config
{
    ...
    public int getRandomTier(final int playerLevel) {
        ...
        return Optional.ofNullable(level.outcomes.getRandom(VaultGearCraftingScalingConfig.rand)).map((Function<? super Object, ? extends Integer>)TierOutcome::getTier).orElse(0);
    }
