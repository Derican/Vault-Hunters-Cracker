...
public class FinalRaidConfig extends Config
{
    ...
    protected void reset() {
        ...
        this.mobPools.put("ranged", Lists.newArrayList((Object[])new RaidConfig.Level[] { new RaidConfig.Level(0, new RaidConfig.MobPool().add((EntityType<?>)EntityType.SKELETON, 1)), new RaidConfig.Level(75, new RaidConfig.MobPool().add((EntityType<?>)EntityType.SKELETON, 1).add((EntityType<?>)EntityType.STRAY, 1)) }));
        this.mobPools.put("melee", Lists.newArrayList((Object[])new RaidConfig.Level[] { new RaidConfig.Level(0, new RaidConfig.MobPool().add((EntityType<?>)EntityType.ZOMBIE, 1)), new RaidConfig.Level(50, new RaidConfig.MobPool().add((EntityType<?>)EntityType.ZOMBIE, 2).add((EntityType<?>)EntityType.VINDICATOR, 1)) }));
        final RaidConfig.WaveSetup waveSetup = new RaidConfig.WaveSetup().addWave(new RaidConfig.CompoundWave(new RaidConfig.ConfiguredWave[] { new RaidConfig.ConfiguredWave(2, 3, "ranged"), new RaidConfig.ConfiguredWave(2, 3, "melee") })).addWave(new RaidConfig.CompoundWave(new RaidConfig.ConfiguredWave[] { new RaidConfig.ConfiguredWave(4, 5, "ranged"), new RaidConfig.ConfiguredWave(4, 6, "melee") })).addWave(new RaidConfig.CompoundWave(new RaidConfig.ConfiguredWave[] { new RaidConfig.ConfiguredWave(6, 7, "ranged"), new RaidConfig.ConfiguredWave(5, 8, "melee") }));
