...
public class VaultChestConfig extends Config
{
    ...
    public List<VaultChestEffect> getAll() {
        return Stream.of((List[])new List[] { this.MOB_TRAP_EFFECTS, this.EXPLOSION_EFFECTS, this.POTION_CLOUD_EFFECTS }).flatMap((Function<? super List, ? extends Stream<?>>)Collection::stream).collect((Collector<? super Object, ?, List<VaultChestEffect>>)Collectors.toList());
    }
