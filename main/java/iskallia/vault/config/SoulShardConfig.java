...
public class SoulShardConfig extends Config {
    ...
    protected void reset() {
        ...
        this.shardTrades.add(new ShardTrade(new SingleItemEntry((IItemProvider) ModItems.SKILL_ESSENCE), 1500, 2500),
                1);
    ...
    public void syncTo(final ServerPlayerEntity player) {
        ModNetwork.CHANNEL.sendTo((Object) new ShardGlobalTradeMessage(this.getShardTrades()),
