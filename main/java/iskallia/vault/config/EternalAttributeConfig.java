...
public class EternalAttributeConfig extends Config {
    ...
    protected void reset() {
        ...
        this.initialAttributes.put(Attributes.MAX_HEALTH.getRegistryName().toString(),
                new FloatRangeEntry(20.0f, 30.0f));
        this.initialAttributes.put(Attributes.ATTACK_DAMAGE.getRegistryName().toString(),
                new FloatRangeEntry(4.0f, 7.0f));
        this.initialAttributes.put(Attributes.MOVEMENT_SPEED.getRegistryName().toString(),
                new FloatRangeEntry(0.2f, 0.23f));
