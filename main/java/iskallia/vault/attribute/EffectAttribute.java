...
public class EffectAttribute extends PooledAttribute<List<Instance>> {
    ...
    public void read(final CompoundNBT nbt) {
        ...
        this.setBaseValue(
                effectsList.stream().map(inbt -> (CompoundNBT) inbt).map(effect -> new Instance(tag.getString("Id")))
                        .collect((Collector<? super Object, ?, List<Instance>>) Collectors.toList()));
    }
    ...
    public static class Generator extends PooledAttribute.Generator<List<EffectAttribute.Instance>, Operator> {
        ...
        public static class Operator extends PooledAttribute.Generator.Operator<List<EffectAttribute.Instance>> {
            ...
            @Override
            public List<EffectAttribute.Instance> apply(final List<EffectAttribute.Instance> value,
                    final List<EffectAttribute.Instance> modifier) {
