...
public class RecipeUtil {
    ...
    public static Optional<Tuple<ItemStack, Float>> findSmeltingResult(final World world, final ItemStack input) {
        ...
        final Optional<IRecipe<IInventory>> optRecipe = (Optional<IRecipe<IInventory>>) ObjectUtils
                .firstNonNull((Object[]) new Optional[] { mgr.getRecipeFor(IRecipeType.SMELTING, inv, world),
                        mgr.getRecipeFor(IRecipeType.CAMPFIRE_COOKING, inv, world),
                        mgr.getRecipeFor(IRecipeType.SMOKING, inv, world), Optional.empty() });
