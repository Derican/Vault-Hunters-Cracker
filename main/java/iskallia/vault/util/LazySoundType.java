...
public class LazySoundType extends SoundType {
    ...
    public LazySoundType(final SoundType vanillaType) {
        super(1.0f, 1.0f, vanillaType.getBreakSound(), vanillaType.getStepSound(), vanillaType.getPlaceSound(),
                vanillaType.getHitSound(), vanillaType.getFallSound());
    }
    ...
    public void initialize(final float volumeIn, final float pitchIn, final SoundEvent breakSoundIn,
            final SoundEvent stepSoundIn, final SoundEvent placeSoundIn, final SoundEvent hitSoundIn,
            final SoundEvent fallSoundIn) {
        if (this.initialized) {
