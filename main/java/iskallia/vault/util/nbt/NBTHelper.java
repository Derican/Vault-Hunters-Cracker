...
public class NBTHelper {
    ...
    public static <T, N extends INBT> Map<UUID, T> readMap(final CompoundNBT nbt, final String name,
            final Class<N> nbtType, final Function<N, T> mapper) {
    ...
    public static <T, N extends INBT> void writeMap(final CompoundNBT nbt, final String name, final Map<UUID, T> map,
            final Class<N> nbtType, final Function<T, N> mapper) {
    ...
    public static <T, N extends INBT> List<T> readList(final CompoundNBT nbt, final String name, final Class<N> nbtType,
            final Function<N, T> mapper) {
    ...
    public static <T, N extends INBT> void writeList(final CompoundNBT nbt, final String name, final Collection<T> list,
            final Class<N> nbtType, final Function<T, N> mapper) {
    ...
    public static <T> void writeOptional(final CompoundNBT nbt, final String key, @Nullable final T object,
            final BiConsumer<CompoundNBT, T> writer) {
